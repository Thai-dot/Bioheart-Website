  ...
  return new ApolloClient({
    link: authLink.concat(
      ApolloLink.from([
        ...
        new HttpLink({
          uri: "https://gateway.delta.bioheart.bioflux.io/", //https://gateway.alpha.bioheart.bioflux.io/
...
//   const uploadLink = createUploadLink({ uri: "https://gateway.alpha.bioheart.bioflux.io/" });
